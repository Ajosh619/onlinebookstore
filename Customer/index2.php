...
?>
	  ...
	  <form method="post" action="cart.php?action=add&id=<?php echo $row[0]; ?>">  
	 <div style="text-align:center">
	  ...
	  <input type="hidden" name="hidden_price" value="<?php echo $row[4]?>" />
...
<div class="col-sm-9 col-md-9 col-lg-9">  
	...
	$prev = $page-1;
	$next = $page+1;
	echo '<ul style="list-style:none;display:inline-block;font-size:20px;">';
